import{_ as n,W as s,X as a,Y as e}from"./framework-9a5142fa.js";const i={},l=e(`<ul><li><a href="#compose-%E4%BD%BF%E7%94%A8%E6%AD%A5%E9%AA%A4">Compose 使用步骤</a></li><li><a href="#docker-compose%E5%91%BD%E4%BB%A4">docker-compose命令</a><ul><li><a href="#docker-composeyml%E7%9A%84%E6%84%8F%E4%B9%89">docker-compose.yml的意义</a></li><li><a href="#%E5%89%8D%E5%8F%B0%E5%90%8E%E5%8F%B0">前台后台</a></li><li><a href="#%E6%89%80%E6%9C%89%E5%AE%B9%E5%99%A8%E5%92%8C%E6%8C%87%E5%AE%9A%E5%AE%B9%E5%99%A8">所有容器和指定容器</a></li><li><a href="#%E9%87%8D%E6%96%B0build%E9%95%9C%E5%83%8F">重新build镜像</a></li><li><a href="#%E5%88%97%E5%87%BA">列出</a></li><li><a href="#%E5%90%AF%E5%8A%A8">启动</a></li><li><a href="#%E5%81%9C%E6%AD%A2%E5%88%A0%E9%99%A4">停止删除</a></li></ul></li><li><a href="#docker-composeyml">docker-compose.yml</a><ul><li><a href="#%E5%9F%BA%E6%9C%AC">基本</a></li><li><a href="#network">network</a></li><li><a href="#links%E4%B8%8D%E7%9F%A5%E9%81%93">links不知道</a></li><li><a href="#%E4%BD%BF%E7%94%A8%E7%8E%B0%E6%88%90%E9%95%9C%E5%83%8F%E5%92%8C%E6%9E%84%E5%BB%BA%E9%95%9C%E5%83%8F">使用现成镜像和构建镜像</a></li><li><a href="#gpu">GPU</a></li></ul></li></ul><hr><h2 id="compose-使用步骤" tabindex="-1"><a class="header-anchor" href="#compose-使用步骤" aria-hidden="true">#</a> Compose 使用步骤</h2><p>定义 <code>docker-compose.yml</code>。 编写构成应用程序的服务，这样它们可以在隔离环境中一起运行。</p><p>最后，执行 docker-compose up 命令来启动并运行整个应用程序。</p><h2 id="docker-compose命令" tabindex="-1"><a class="header-anchor" href="#docker-compose命令" aria-hidden="true">#</a> docker-compose命令</h2><h3 id="docker-compose-yml的意义" tabindex="-1"><a class="header-anchor" href="#docker-compose-yml的意义" aria-hidden="true">#</a> docker-compose.yml的意义</h3><p><code>docker-compose</code> 所执行的命令都是在其中指定的容器，不相干的不操作。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 默认当前是docker-compose.yml。</span>
...
<span class="token punctuation">-</span> <span class="token key atrule">driver</span><span class="token punctuation">:</span> nvidia
  ...
  <span class="token key atrule">capabilities</span><span class="token punctuation">:</span> <span class="token punctuation">[</span>gpu<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="3"><li>If no count or device_ids are set, <strong>all</strong> GPUs available on the host are going to be used by default.</li></ol>`,44),c=[l];function o(t,p){return s(),a("div",null,c)}const r=n(i,[["render",o],["__file","docker-compose.html.vue"]]);export{r as default};
