import{_ as s,W as a,X as n,Y as e}from"./framework-9a5142fa.js";const t={},l=e(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>yum <span class="token function">install</span> <span class="token parameter variable">-y</span> net-tools
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,12),i=[l];function r(o,p){return a(),n("div",null,i)}const d=s(t,[["render",r],["__file","修改网络ip.html.vue"]]);export{d as default};
