...
---------------------------------
Start Port      <span class="token builtin class-name">:</span> <span class="token number">1024</span>		【问题！】
...
net start winnat
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>（2）<s>为了以防这种windows更新而导致「TCP 动态端口范围」异常的问题，直接关闭hyper-V</s>。不行，因为wsl2需要Hyper-V！</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>dism.exe /Online /Disable-Feature:Microsoft-Hyper-V
