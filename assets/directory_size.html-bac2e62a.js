import{_ as e,W as n,X as s,$ as a}from"./framework-586fce15.js";const i={},d=a(`<h2 id="目录层级" tabindex="-1"><a class="header-anchor" href="#目录层级" aria-hidden="true">#</a> 目录层级</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">apt</span> <span class="token function">install</span> tree
