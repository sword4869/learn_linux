import{_ as s,W as n,X as a,Y as e}from"./framework-9a5142fa.js";const l={},i=e(`<h1 id="script-arguments" tabindex="-1"><a class="header-anchor" href="#script-arguments" aria-hidden="true">#</a> script arguments</h1><blockquote><p>first argument is the name of the srcipt.</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token shebang important">#! /bin/bash</span>
...
<span class="token number">2</span>           <span class="token comment"># 2个参数</span>
