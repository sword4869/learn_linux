import{_ as e,W as n,X as a,Y as s}from"./framework-9a5142fa.js";const i={},l=s(`<p>[toc]</p><h2 id="远程仓库管理" tabindex="-1"><a class="header-anchor" href="#远程仓库管理" aria-hidden="true">#</a> 远程仓库管理</h2><h3 id="显示有哪些" tabindex="-1"><a class="header-anchor" href="#显示有哪些" aria-hidden="true">#</a> 显示有哪些</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">git</span> remote
origin
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="add-a-remote-repository" tabindex="-1"><a class="header-anchor" href="#add-a-remote-repository" aria-hidden="true">#</a> add a remote repository</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># git remote add &lt;remote repository name&gt; &lt;remote repository url&gt;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ol><h2 id="clone" tabindex="-1"><a class="header-anchor" href="#clone" aria-hidden="true">#</a> clone</h2><p><code>git clone 和 git clone -b 分支</code> 都会下载所有分支，只是下载后的检出不同。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 下载所有分支 + 检出为默认分支</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果有分支不想下载，想要加快下载速度，那么可以只下载指定分支并检出</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> clone <span class="token parameter variable">-b</span> 分支名 --single-branch origin
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="pull-fetch-merge" tabindex="-1"><a class="header-anchor" href="#pull-fetch-merge" aria-hidden="true">#</a> pull = fetch + merge</h2><h3 id="pull" tabindex="-1"><a class="header-anchor" href="#pull" aria-hidden="true">#</a> pull</h3><p>基本用法：<code>git pull &lt;远程仓库&gt; &lt;远程分支&gt;:&lt;本地分支&gt;</code>。远程分支→本地分支</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 将远程主机origin的master分支拉取过来，与本地的brantest分支合并。</span>
$ <span class="token function">git</span> pull origin master:brantest

<span class="token comment"># 默认本地分支同远程名</span>
$ <span class="token function">git</span> pull origin master
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="pull-rebase" tabindex="-1"><a class="header-anchor" href="#pull-rebase" aria-hidden="true">#</a> pull --rebase</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> pull <span class="token parameter variable">--rebase</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,52),d=[l];function t(r,c){return n(),a("div",null,d)}const p=e(i,[["render",t],["__file","remote.html.vue"]]);export{p as default};
