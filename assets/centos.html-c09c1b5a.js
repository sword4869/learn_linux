import{_ as s,W as a,X as n,Y as e}from"./framework-9a5142fa.js";const l={},i=e(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>yum <span class="token function">install</span> <span class="token parameter variable">-y</span> net-tools
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="重启网络失败-job-for-network-service-failed" tabindex="-1"><a class="header-anchor" href="#重启网络失败-job-for-network-service-failed" aria-hidden="true">#</a> 重启网络失败 Job for network.service failed</h1><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>Restarting network <span class="token punctuation">(</span>via systemctl<span class="token punctuation">)</span>: Job <span class="token keyword">for</span> network.service failed because the control process exited with error code.
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,12),t=[i];function r(o,c){return a(),n("div",null,t)}const d=s(l,[["render",r],["__file","centos.html.vue"]]);export{d as default};
