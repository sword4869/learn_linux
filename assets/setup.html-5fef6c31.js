import{_ as t,W as d,X as u,Z as n,a0 as s,a1 as o,$ as e,Y as i,E as a}from"./framework-9a5142fa.js";const c={},p=n("hr",null,null,-1),v=n("h2",{id:"part-1",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#part-1","aria-hidden":"true"},"#"),e(" part 1")],-1),b=n("h2",{id:"part-2",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#part-2","aria-hidden":"true"},"#"),e(" part 2")],-1),m=i(`<li><p>wsl2</p><p>更改新分发的默认安装版本。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>    --set-default-version <span class="token operator">&lt;</span>Version<span class="token operator">&gt;</span>
    更改新分发的默认安装版本。
