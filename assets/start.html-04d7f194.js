import{_ as s,W as e,X as n,Y as a}from"./framework-9a5142fa.js";const i={},l=a(`<h1 id="script-and-console" tabindex="-1"><a class="header-anchor" href="#script-and-console" aria-hidden="true">#</a> script and console</h1><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token shebang important">#! /bin/bash</span>
