...
<span class="token comment"># %作业序号. </span>
<span class="token function">bg</span> %1
<span class="token comment"># 有的机子可以直接输入作业序号，centos就不行</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,33),c=[p];function t(o,l){return s(),a("div",null,c)}const u=n(i,[["render",t],["__file","fg bg jobs.html.vue"]]);export{u as default};
