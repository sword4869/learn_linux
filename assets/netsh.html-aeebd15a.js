...
C:\\Windows\\system32&gt;netsh interface set interface &quot;WLAN&quot; disabled
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,30);function r(o,m){const s=c("ExternalLinkIcon");return e(),i("div",null,[n("p",null,[n("a",u,[l("Windows 中的 netsh 是一个命令行实用程序，用于配置和监视网络参数，例如网络接口、防火墙、IPsec、无线网络等。netsh 是 Network Shell 的缩写，可以通过命令行或脚本文件来执行各种网络相关操作 - suv789 - 博客园 (cnblogs.com)"),t(s)])]),p])}const g=a(v,[["render",r],["__file","netsh.html.vue"]]);export{g as default};
