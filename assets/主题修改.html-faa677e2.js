import{_ as e,W as i,X as n,Y as d}from"./framework-9a5142fa.js";const a={},s=d(`<h2 id="修改" tabindex="-1"><a class="header-anchor" href="#修改" aria-hidden="true">#</a> 修改</h2><p><code>G:\\工具箱\\Typora\\resources\\style\\themes</code></p><p><img src="https://cdn.jsdelivr.net/gh/sword4869/pic1@main/images/202410241229172.png" alt="image-20241024122923132"></p><p>基于 github风格的</p><h2 id="默认-完全看不出左右" tabindex="-1"><a class="header-anchor" href="#默认-完全看不出左右" aria-hidden="true">#</a> 默认<code>“”</code>完全看不出左右</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>body {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code>font-size: 0.9em;</code> 调整为 <code>0.8em</code></p><h3 id="code-inline" tabindex="-1"><a class="header-anchor" href="#code-inline" aria-hidden="true">#</a> code inline \`\`</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>code {
    background-color: #f3f4f4;
    padding: 0 2px 0 2px;
    font-size: 1em;   /* new */
}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>让其和正常字体一样大小</p><h2 id="占满屏幕" tabindex="-1"><a class="header-anchor" href="#占满屏幕" aria-hidden="true">#</a> 占满屏幕</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#write {
    max-width: 860px;
  	margin: 0 auto;
  	padding: 30px;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,19),l=[s];function r(c,t){return i(),n("div",null,l)}const o=e(a,[["render",r],["__file","主题修改.html.vue"]]);export{o as default};
