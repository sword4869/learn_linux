import{_ as s,W as n,X as a,Y as e}from"./framework-9a5142fa.js";const i={},l=e(`<p>[toc]</p><h2 id="usename" tabindex="-1"><a class="header-anchor" href="#usename" aria-hidden="true">#</a> usename</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">whoami</span>
user1
...
$ neofetch
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,13),c=[l];function t(p,o){return n(),a("div",null,c)}const r=s(i,[["render",t],["__file","information.html.vue"]]);export{r as default};
